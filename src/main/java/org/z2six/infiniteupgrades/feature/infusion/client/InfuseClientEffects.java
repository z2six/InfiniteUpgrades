 ...
 * - Plays SFX exactly when the fill finishes (flashing begins), regardless of GUI state.
...
public final class InfuseClientEffects {
    ...
    /** Play exactly at flashing start (when fill phase completes); also start the overlay animation. */
